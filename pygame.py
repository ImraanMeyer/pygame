...
enemy1 = pygame.image.load("images/monster.jpg") 
enemy2 = pygame.image.load("images/enemy4.jpg")  
enemy3 = pygame.image.load("images/enemy3.jpg")
prize = pygame.image.load("images/prize.jpg")
